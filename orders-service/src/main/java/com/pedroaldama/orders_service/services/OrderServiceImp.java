...
import com.pedroaldama.orders_service.model.dto.*;
...
import com.pedroaldama.orders_service.repositories.OrderRepository;
...
public class OrderServiceImp implements OrderService{
    ...
    public void placeOrder(OrderRequest orderRequest) {
        ...
        order.setOrderItems(orderRequest.getOrderItems().stream().map(orderItemRequest -> {
                    return mapOrderITemRequestToOrderItem(orderItemRequest,order);
